---
date: 2023-10-30T14:53:19+0000
source: https://pypi.org/project/flask-login/
---
# Flask-Login

[image: Tests] [image: coverage] [image: Software License]
...
1. Make your changes
1. Install the dev requirements with pip install -r requirements/dev.txt
1. Submit a pull request after running tox (ensure it does not error!)
