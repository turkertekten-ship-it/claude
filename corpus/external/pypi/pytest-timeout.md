---
date: 2025-05-05T19:44:33+0000
source: https://pypi.org/project/pytest-timeout/
---
[image: python] [image: version] [image: anaconda] [image: ci] [image: pre-commit]
...
1. You can set a global timeout in the pytest configuration file
...
timeout = 300
``` 
1. The PYTEST_TIMEOUT environment variable sets a global timeout
overriding a possible value in the configuration file.
1. The --timeout command line option sets a global timeout
overriding both the environment variable and configuration option.
1. Using the timeout marker on test items you can specify
...
be alleviated by using the --forked option of the pytest-forked
plugin.
...
option in the pytest configuration file, the --timeout_method
command line parameter or the timeout marker. Simply set their
...
See the marker api documentation and examples for the various ways
...
See pytest hooks documentation for more info
...
| func_only | 2 | Apply timeout to test function only if True, wrap all test function and its fixtures otherwise |
