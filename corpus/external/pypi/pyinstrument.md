---
date: 2026-07-29T17:17:16+0000
source: https://pypi.org/project/pyinstrument/
---
# pyinstrument

[image: PyPI version] [image: .github/workflows/test.yml] [image: Build wheels]
...
focus on the slowest part of your program.
...
interactive viewer using the JSON output!
...
is the -m flag e.g. pyinstrument -m module_name! PR
