---
date: 2026-08-23T17:45:07+0000
source: https://pypi.org/project/pytest-benchmark/
---
| docs | [image: Documentation Status] [image: Join the chat at https://gitter.im/ionelmc/pytest-benchmark] |
| tests | [image: GitHub Actions Build Status] [image: Coverage Status] [image: Coverage Status] |
| package | [image: PyPI Package latest release] [image: PyPI Wheel] [image: Supported versions] [image: Supported implementations] [image: Commits since latest release] |
...
> Take a look at the introductory material
> or watch talks. Few notes: This plugin benchmarks functions and only that. If you want to measure block of code
> or whole programs you will need to write a wrapper function. In a test you can only benchmark one function. If you want to benchmark many functions write more tests or
> use parametrization. To run the benchmarks you simply use pytest to run your “tests”. The plugin will automatically do the
...
rounds) there’s a special mode - pedantic:
...
Normal run:
 ...
 [image: Screenshot of pytest summary]

Compare mode (--benchmark-compare):

 [image: Screenshot of pytest summary in compare mode]

Histogram (--benchmark-histogram):

 [image: Histogram sample]

> Also, it has nice tooltips.

Compare between mode (pytest-benchmark compare --between):

 [image: Screenshot of pytest summary in compare between mode]
...
Contributed by xlyyddy in #317
(fixes #65).
- Replaced deprecated argparse.FileType.
Contributed by Sophia Castellarin in #310.
...
Contributed Patrick Winter by #264.
- Added --benchmark-time-unit option.
Contributed by Tony Kuo in #281.
- Fixed deprecated hook examples in docstrings.
Contributed by Ali-Akber Saifee in #284.
- Changed --benchmark-compare-fail to accept percentages higher than 100%.
Contributed by Ben Avrahami in #280.
- Added minimal typing support.
Contributed by Sorin Sbarnea in #290.
- Fixed support for Python 3.9.
Contributed by Enno Gotthold in #291.
...
- Fix generate parametrize tests benchmark csv report errors (issue #268).
Contributed by Johnny Huang in #269.
- Added the --benchmark-time-unit cli option for overriding the measurement unit used for display.
Contributed by Tony Kuo in #257.
- Fixes spelling in some help texts.
Contributed by Eugeniy in #267.
...
Contributed by Miroslav Šedivý in #189.
...
particular the exact model. Contributed by Antonio Cuni in #61.
...
param name). Contributed by Antonio Cuni in #37.
