...
[image: PyPI status] [image: License] [image: Python versions supported]

[image: Test suite status] [image: Quality check status] [image: Documentation] [image: Coverage reports]

[image: Tidelift] [image: Sponsor me on GitHub] [image: GitHub stars] [image: coveragepy on Mastodon] [image: nedbat on Mastodon] [image: nedbat on Bluesky]
...
| [image: Tidelift] | Available as part of the Tidelift Subscription.
