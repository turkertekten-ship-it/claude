---
date: 2026-07-22T04:13:10+0000
source: https://pypi.org/project/plumbum/
---
[image: Documentation Status] [image: Build Status] [image: Coverage Status] [image: PyPI Status] [image: PyPI Versions] [image: Conda-Forge Badge] [image: PyPI License] [image: Join the chat at https://gitter.im/plumbumpy/Lobby] [image: Code styled with Black]
...
Supports openSSH-compatible clients,
PuTTY (on Windows)
and Paramiko (a pure-Python implementation of SSH2)
