---
date: 2026-06-22T16:07:48+0000
source: https://pypi.org/project/prettytable/
---
# PrettyTable
...
containing what would be printed if you use print(table), you can use the
get_string method:
...
#### Custom format example (with colors)
...
After editing files, use at least Black to auto-format
changed lines.
