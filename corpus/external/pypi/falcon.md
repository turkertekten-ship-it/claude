---
date: 2026-06-16T05:31:23+0000
source: https://pypi.org/project/falcon/
---
[image: Falcon logo]

[image: Build status] [image: Falcon web framework docs] [image: codecov.io] [image: PyPI package] [image: Python versions]

## The Falcon Web Framework

Falcon is a minimalist ASGI/WSGI framework for
...
Falcon apps work with any WSGI
or ASGI server, and run like a
...
[image: TestMu AI] [image: CERT Gouvernemental Luxembourg] [image: Sentry]
...
> to add, but when there is no longer anything to take away. - Antoine de Saint-Exupéry
...
SemVer) with a major version increment. The code is
...
available, and also works well with PyPy. Considering a
...
falconry/dev room for discussing
...
PyPy is the fastest way to run your Falcon app.
...
with Cython under any
PEP 517-compliant installer.
...
Falcon speaks WSGI (or
ASGI; see also below). In order to
...
Falcon lives on GitHub, making the
