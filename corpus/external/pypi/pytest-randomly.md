---
date: 2026-04-20T13:01:50+0000
source: https://pypi.org/project/pytest-randomly/
---
[image: https://img.shields.io/github/actions/workflow/status/pytest-dev/pytest-randomly/main.yml.svg?branch=main&style=for-the-badge] [image: https://img.shields.io/badge/Coverage-100%25-success?style=for-the-badge] [image: https://img.shields.io/pypi/v/pytest-randomly.svg?style=for-the-badge] [image: https://img.shields.io/badge/code%20style-black-000000.svg?style=for-the-badge] [image: pre-commit]
...
- At the start of the test run, and before each test setup, run, and teardown, it resets Python’s global random seed to a fixed value, using random.seed().
...
The faker pytest fixture is also affected, as pytest-randomly defines the faker_seed fixture.
 - Model Bakery
 - NumPy

Only its legacy random state is affected.
- If additional random generators are used, they can be registered under the
pytest_randomly.random_seeder entry point and
...
Alternatively, a reverse order of test executions, as provided by pytest-reverse, may find less dependent
...
See its documentation section on usage with pytest-randomly.
