---
date: 2026-01-26T02:42:59+0000
source: https://pypi.org/project/multidict/
---
[image: GitHub status for master branch] [image: Coverage metrics] [image: PyPI] [image: Read The Docs build status badge] [image: CodSpeed] [image: Python versions] [image: Matrix Room — #aio-libs:matrix.org] [image: Matrix Space — #aio-libs-space:matrix.org]
