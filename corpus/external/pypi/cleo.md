---
date: 2023-10-30T18:54:08+0000
source: https://pypi.org/project/cleo/
---
# Cleo

[image: Poetry] [image: Tests] [image: PyPI version]
...
like -y). Options are always optional, and can be setup to accept a
value (e.g. --dir=src) or simply as a boolean flag without a value
(e.g. --yell).

> Tip: It is also possible to make an option optionally accept a value (so
