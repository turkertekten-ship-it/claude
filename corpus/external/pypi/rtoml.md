---
date: 2025-10-19T04:57:52+0000
source: https://pypi.org/project/rtoml/
---
# rtoml

[image: Actions Status] [image: Coverage] [image: pypi] [image: versions] [image: license]

A TOML library for python implemented in rust.

## Why Use rtoml

- Correctness: rtoml is based on the widely used and very stable toml-rs
library, it passes all the standard TOML tests as well as having 100%
coverage on python code. Other TOML libraries for python I tried all failed to parse some valid TOML.
- Performance: see github.com/pwwang/toml-bench -
