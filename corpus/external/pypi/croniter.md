---
date: 2026-07-10T09:52:58+0000
source: https://pypi.org/project/croniter/
---
## Introduction
...
Some vixie/ISC cron implementations have a known bug where expressions that start with
...
> Apr-Jan: from April to january Sat-Sun: Saturday, Sunday Wed-Sun: Wednesday to Saturday, Sunday
...
> Keyword No hash_id With hash_id @midnight 0 0 * * * H H(0-2) * * * H @hourly 0 * * * * H * * * * H @daily 0 0 * * * H H * * * H @weekly 0 0 * * 0 H H * * H H @monthly 0 0 1 * * H H H * * H @yearly 0 0 1 1 * H H H H * H @annually 0 0 1 1 * H H H H * H
...
Now you can run the formatters (fmt), linters (lint) and tests (test) using tox through uv.
...
> Aarni Koskela (akx) ashb bdrung chris-baynes djmitche evanpurkhiser GreatCombinator Hinnack ipartola jlsandell kiorky lowell80 (Kintyre) mag009 mrmachine potiuk Ryan Finnie (rfinnie) salitaba scop shazow yuzawa-san zed2015
