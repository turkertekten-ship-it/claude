...
[image: Actions Status] [image: Documentation Status] [image: Coverage Status] [image: License: MIT] [image: PyPI] [image: Supported Python Versions] [image: Downloads] [image: conda-forge] [image: Code style: black]
...
Our documentation covers the current Black code style, but planned changes to it are
...
Black does make some exceptions to rules it otherwise holds.
...
The following organizations use Black: Dropbox, KeepTruckin, Lyft, Mozilla, Quora,
...
Everyone participating in the Black project, and in particular in the issue tracker,
