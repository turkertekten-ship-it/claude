---
date: 2026-08-17T02:59:17+0000
source: https://pypi.org/project/rq/
---
...
[image: Build status] [image: PyPI] [image: Coverage] [image: Code style: Ruff]
...
To avoid pickle, use an alternative serializer, such as JSONSerializer, when enqueueing and processing jobs (see docs). JSON only supports primitive argument types (str, int, float, bool, list, dict, None).
