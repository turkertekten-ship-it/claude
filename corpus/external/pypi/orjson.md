...
published is github.com/ijl/orjson and an
alternative repository is codeberg.org/ijl/orjson.
...
To package orjson requires at least Rust 1.95,
a C compiler, and the maturin build tool.
