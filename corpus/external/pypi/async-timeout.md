---
date: 2024-11-06T16:41:37+0000
source: https://pypi.org/project/async-timeout/
---
[image: https://travis-ci.com/aio-libs/async-timeout.svg?branch=master] [image: https://codecov.io/gh/aio-libs/async-timeout/branch/master/graph/badge.svg] [image: https://img.shields.io/pypi/v/async-timeout.svg] [image: Chat on Gitter]
...
happens.
1. Otherwise inner() is cancelled internally by sending
