---
date: 2026-02-22T14:40:57+0000
source: https://pypi.org/project/universal-pathlib/
---
# Universal Pathlib

[image: PyPI - Python Version] [image: PyPI - License] [image: PyPI] [image: Conda (channel only)]

[image: Docs] [image: Tests] [image: GitHub issues] [image: Codestyle black] [image: Changelog]

Universal Pathlib is a Python library that extends the
pathlib_abc.JoinablePath API to provide a
pathlib.Path-like interface for a variety of backend filesystems
via filesystem_spec.
...
See filesystem_spec/pyproject.toml for an overview of the available
fsspec extras.
...
into limitations, please file an issue with a detailed description. We
