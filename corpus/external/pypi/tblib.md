---
date: 2025-11-12T12:21:14+0000
source: https://pypi.org/project/tblib/
---
...
> >>> fromtblibimport pickling_support>>> # Declare all imports of your package's dependencies>>> importnumpy # doctest: +SKIP>>> pickling_support.install() # install for all modules imported so far>>> @pickling_support.install... classCustomError(Exception):... pass

Eventual subclasses of CustomError will need to be decorated again.
1. Invoke pickling_support.install() after all modules have been imported and all
Exception subclasses have been declared

> >>> # Declare all imports of your package's dependencies>>> importnumpy # doctest: +SKIP>>> fromtblibimport pickling_support>>> # Declare your own custom Exceptions>>> classCustomError(Exception):... pass>>> # Finally, install tblib>>> pickling_support.install()
1. Selectively install tblib for Exception instances just before they are pickled
...
Contributed by Jacob Tomlinson in #85.
...
Tests and POC contributed by Oldřich Jedlička in #73.
...
Contributed by Haoyu Weng in #81.
...
Contributed by Tim Maxwell in #72.
