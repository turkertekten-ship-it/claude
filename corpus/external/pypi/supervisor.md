---
date: 2025-08-23T18:25:00+0000
source: https://pypi.org/project/supervisor/
---
...
You can view the current Supervisor documentation online in HTML format . This is where you should go for detailed
...
- Fixed a bug where the warning Supervisord is running as root and it is searching for its config file may have been incorrectly shown by
...
would crash supervisord with the error OSError: [Errno 9] Bad file descriptor if the kqueue poller was used. Patch by Jared Suttles.
