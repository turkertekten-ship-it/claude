---
date: 2025-11-16T16:26:08+0000
source: https://pypi.org/project/keyring/
---
[image: https://img.shields.io/pypi/v/keyring.svg] [image: https://img.shields.io/pypi/pyversions/keyring.svg] [image: tests] [image: Ruff] [image: https://readthedocs.org/projects/keyring/badge/?version=latest] [image: https://img.shields.io/badge/skeleton-2025-informational] [image: https://tidelift.com/badges/package/pypi/keyring] [image: Join the chat at https://gitter.im/jaraco/keyring]
...
- macOS Keychain
- Freedesktop Secret Service supports many DE including
...
On Linux, the KWallet backend relies on dbus-python, which does not always
...
initially carried it out as a Google Summer of Code project, and Tarek
