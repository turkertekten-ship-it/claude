---
date: 2025-04-24T03:35:24+0000
source: https://pypi.org/project/h11/
---
[image: Automated test status] [image: Test coverage] [image: Documentation Status]
...
1. When you read data off the network, pass it to
conn.receive_data(...); you’ll get back a list of objects
representing high-level HTTP “events”.
1. When you want to send a high-level HTTP event, create the
