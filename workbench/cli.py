...
def cmd_doctor(args: argparse.Namespace) -> int:
    ...
    print(f"                        {api_why[:150]}")
    print("                        Built and offline-tested: exact max_tokens,")
    print("                        count_tokens before sending, batch submission,")
    print("                        and temperature/top_p/top_k on models old enough")
    print("                        to accept them. Run with --backend")
