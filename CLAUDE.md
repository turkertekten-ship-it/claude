...
14. [guards] Never narrow a check a fourth time when real cases still misjudge it, because an UNDATED_STATE rule took four narrowings and remained wrong on four of nine cases; the mechanism was wrong rather than one exception short. [routed to: .claude/skills/ooda/SKILL.md]
